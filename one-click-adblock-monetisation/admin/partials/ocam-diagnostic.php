...
<h1><?php _e('AdBack : The stats of your AdBlock audience', 'one-click-adblock-monetisation'); ?></h1>

<p>
    <?php _e('Statistics description', 'one-click-adblock-monetisation'); ?>
</p>
<hr class="clear">
