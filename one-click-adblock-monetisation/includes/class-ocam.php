...
class One_Click_Adblock_Monetisation
{
     ...
     * @since    1.0.0
     * @access   protected
     * @var      Ocam_Loader    $loader    Maintains and registers all hooks for the plugin.
     */
    protected $loader;
     ...
     *
     * - Ocam_Loader. Orchestrates the hooks of the plugin.
     * - Ocam_i18n. Defines internationalization functionality.
     * - Ocam_Admin. Defines all hooks for the admin area.
     * - Ocam_Public. Defines all hooks for the public side of the site.
     *
     ...
     *
     * Uses the Ocam_i18n class in order to set the domain and to register the hook
     * with WordPress.
     *
     * @since    1.0.0
     * @access   private
    ...
    {
        $plugin_admin = new Ocam_Admin( $this->getPluginName(), $this->getVersion() );
    ...
    {
        $plugin_public = new Ocam_Public( $this->getPluginName(), $this->getVersion() );
     ...
     *
     * @since     1.0.0
     * @return    Ocam_Loader    Orchestrates the hooks of the plugin.
     */
